...
try {
    ...
    $stmt = $db->prepare("SELECT B.alamat, A.nama_penarik, A.nama_penerima, A.penggunaan_dana, B.nomor_identitas, B.nama_lengkap, A.id_trans, A.no_rekening, A.nominal, A.jenis_trans, A.status_trans, A.tgl_trans, A.jam_trans
    ...
    if ($transaksi) {
        ...
        $nama_penarik = $transaksi['nama_penarik'] ?: 'N/A';
        $nama_penerima = $transaksi['nama_penerima'] ?: 'N/A';
        $penggunaan_dana = $transaksi['penggunaan_dana'] ?: '';
...
<body>
    ...
    <div class="content">
        <table>
            ...
            <tr>
                <td>Transaksi</td>
                <td>: Pengambilan Tunai</td>
            </tr>
            <tr>
                <td>Penggunaan Dana</td>
                <td>: <?php echo $penggunaan_dana; ?></td>
            </tr>
            <tr>
                <td>Jumlah</td>
